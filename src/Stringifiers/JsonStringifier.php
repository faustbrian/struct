...
/**
 * Serializes data objects into JSON.
 *
 * @author Brian Faust <brian@cline.sh>
 */
final class JsonStringifier implements StringifierInterface
{
    public function stringify(
        DataObjectInterface $dto,
        ?SerializationOptions $options = null,
    ): string {
        return $dto->toJson(serialization: $options ?? new SerializationOptions());
    }
}
