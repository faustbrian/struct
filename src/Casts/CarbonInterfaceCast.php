...
/**
 * Casts values to and from `CarbonInterface` instances.
 *
 * @author Brian Faust <brian@cline.sh>
 * @psalm-immutable
 */
final readonly class CarbonInterfaceCast implements CastInterface
{
    ...
    /**
     * Cast an incoming value into a CarbonInterface instance when needed.
     */
    ...
    /**
     * Prepare the given value for storage from a CarbonInterface-compatible value.
     */
