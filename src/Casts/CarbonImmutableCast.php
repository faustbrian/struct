...
/**
 * Casts values to and from `CarbonImmutable` instances.
 *
 * @author Brian Faust <brian@cline.sh>
 * @psalm-immutable
 */
final readonly class CarbonImmutableCast implements CastInterface
{
    ...
    /**
     * Prepare the given value for storage from a CarbonImmutable-compatible value.
     */
