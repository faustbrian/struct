...
/**
 * Rounds a numeric property toward zero.
 *
 * @author Brian Faust <brian@cline.sh>
 * @psalm-immutable
 */
#[Attribute(Attribute::TARGET_PROPERTY)]
final readonly class RoundDown implements ConfiguresNumericRoundingInterface, ProvidesCastClassInterface
{
    public function __construct(
        public int $precision = 0,
        public RoundingMode $mode = RoundingMode::TowardsZero,
    ) {}
