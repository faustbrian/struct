...
final readonly class WhereInstanceOf implements TransformsLaravelCollectionValueInterface
{
    /**
     * @param array<array-key, class-string>|class-string $type
     */
    ...
    {
        return $items->whereInstanceOf($this->type);
    }
}
