...
final readonly class Forget implements TransformsLaravelCollectionValueInterface
{
    /**
     * @param array<array-key, int|string>|int|string $keys
     */
    public function __construct(
        public array|int|string $keys,
    ) {}

    public function transformCollection(Collection $items, ?CreationContext $context = null): Collection
    {
        $items = clone $items;
        $items->forget($this->keys);
