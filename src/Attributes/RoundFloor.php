...
/**
 * Rounds a numeric property toward negative infinity.
 *
 * @author Brian Faust <brian@cline.sh>
 * @psalm-immutable
 */
#[Attribute(Attribute::TARGET_PROPERTY)]
final readonly class RoundFloor implements ConfiguresNumericRoundingInterface, ProvidesCastClassInterface
{
    public function __construct(
        public int $precision = 0,
        public RoundingMode $mode = RoundingMode::NegativeInfinity,
    ) {}
